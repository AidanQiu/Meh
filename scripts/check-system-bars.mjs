...
check(html.includes('platformClass === "platform-ios-pwa"') && html.includes("themeMeta.remove()"), "iOS PWA bootstrap must remove theme-color");
...
check(css.includes("#viewport-background") && css.includes("background-image: var(--app-background) !important"), "the fixed viewport layer must paint the complete visual background");
...
check(css.includes("background-color: transparent !important") && css.includes("background-color: var(--surface) !important") && css.includes("background-image: var(--app-background) !important"), "html must be transparent while the fixed viewport layer owns the fallback and visual background");
check(app.includes('classList.contains("platform-ios-pwa")') && app.includes("meta.remove()"), "runtime theme updates must remove theme-color in iOS PWA mode");
